...
//            return Base64.encodeBase64URLSafeString(sig);
            return Base64.encodeToString(sig, Base64.URL_SAFE | Base64.NO_WRAP);
        } catch (Exception e) {
    ...
    private static String encodeJson(JSONObject jsonData) {
        return Base64.encodeToString(jsonData.toString().getBytes(UTF8_CHARSET), Base64.URL_SAFE | Base64.NO_WRAP);
    }
}
